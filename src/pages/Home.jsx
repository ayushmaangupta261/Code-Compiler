...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      {/* Hero Section */}
      <div className='w-11/12 h-auto  mx-auto mt-[7rem] flex flex-col  justify-evenly items-center text-white '>
        ...
        <div className='flex justify-evenly items-center mt-[4rem] text-white w-full'>


          {/* right */}
          <div className='text-white w-[30%] z-0 text-start flex flex-col gap-y-5 font-semibold  mr-10'>
            <p className='text-4xl bg-gradient-to-r from-orange-500 to-orange-800 text-transparent bg-clip-text'>CodeLab</p>
      ...
      {/*  code editor */}
      <div className='w-[80%] flex mt-[5rem] justify-between mx-auto items-start gap-x-10'>

        {/* left */}
        <div className='flex w-[50%] justify-start z-0'>
          <img src={code} alt="" className='w-[100%]' />

        </div>

        {/* right */}
        <div className='w-[50%] mt-[5rem] flex flex-col items-start'>
          <p className='text-4xl font-semibold'><span className='bg-gradient-to-r from-orange-500 to-orange-800 text-transparent bg-clip-text'>Online Co</span><span className='text-emerald-500'>de Editor</span></p>
